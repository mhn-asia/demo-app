...
import { CadMockApiReplyCallback } from '@cad/lib/mock-api/mock-api.types';

export class CadMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: CadMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: CadMockApiReplyCallback): void
    {
        // Store the reply
