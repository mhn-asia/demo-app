...
import { FSDocument, FSDocumentElement } from '@cad/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'cad-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'cadFullscreen'
})
export class CadFullscreenComponent implements OnInit
{
