...
}) =>
{
    ...
    */
    addComponents(
        {
            ...
            '.bg-card'        : {
                ...
                backgroundColor  : 'rgba(var(--cad-bg-card-rgb), var(--tw-bg-opacity)) !important'
            },
            '.bg-default'     : {
                '--tw-bg-opacity': '1 !important',
                backgroundColor  : 'rgba(var(--cad-bg-default-rgb), var(--tw-bg-opacity)) !important'
            },
            '.bg-dialog'      : {
                '--tw-bg-opacity': '1 !important',
                backgroundColor  : 'rgba(var(--cad-bg-dialog-rgb), var(--tw-bg-opacity)) !important'
            },
            '.ring-bg-default': {
                '--tw-ring-opacity': '1 !important',
                '--tw-ring-color'  : 'rgba(var(--cad-bg-default-rgb), var(--tw-ring-opacity)) !important'
            },
            '.ring-bg-card'   : {
                '--tw-ring-opacity': '1 !important',
                '--tw-ring-color'  : 'rgba(var(--cad-bg-card-rgb), var(--tw-ring-opacity)) !important'
            }
        }
    );
    ...
    addComponents(
        {
            '.bg-hover': {
                backgroundColor: 'var(--cad-bg-hover) !important'
            }
        }
    );
});
